...
class MNET(nn.Module):
	...
	super(MNET, self).__init__()
        self.conv1_1 = nn.Conv2d(1, 8, 11, padding=5)
        self.relu1_1 = nn.ReLU(inplace=True)
        self.conv1_2 = nn.Conv2d(8, 8, 11, padding=5)
        self.relu1_2 = nn.ReLU(inplace=True)
        self.conv1_3 = nn.Conv2d(8, 8, 11, padding=5)
        self.relu1_3 = nn.ReLU(inplace=True)
        self.conv1_4 = nn.Conv2d(8, 8, 11, padding=5)
        self.relu1_4 = nn.ReLU(inplace=True)
        self.conv1_5 = nn.Conv2d(8, 8, 11, padding=5)
        self.relu1_5 = nn.ReLU(inplace=True)
        self.conv1_6 = nn.Conv2d(8, 8, 11, padding=5)
        self.relu1_6 = nn.ReLU(inplace=True)
        self.conv1_7 = nn.Conv2d(8, 8, 5, padding=2)
        self.relu1_7 = nn.ReLU(inplace=True)
        self.conv1_8 = nn.Conv2d(8, 2, 5, padding=2)
